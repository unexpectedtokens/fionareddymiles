...
export const projects: Project[] = [
  ...
  {
    title: {
      en: "House in Campo Timbó",
      es: "Casa en Campo Timbó",
    },
    slug: "campo-timbo",
    description: {
      en: 'The house is located in Campo Timbo, 54 kilometers from the city of Rosario, on a lot near the Carcaraña river characterized by its varied biodiversity and periodic flooding. In this context, the house is positioned at the transition between the natural riverbanks and the neighborhood\'s golf course. The house is conceived as an L-shaped courtyard house where the common areas form a continuous space that opens onto the courtyard and frames the forest before the golf. Meanwhile, the more private areas are located along one wing of the "L" taking advantage of the geometry to create more intimate visual connections with the exterior.',
      es: "La casa está ubicada en Campo Timbó, a 54 kilómetros de la ciudad de Rosario, en un terreno próximo al río Carcarañá, caracterizado por su variada biodiversidad y la dinámica de sus crecidas. De esta manera, la casa se encuentra en el punto de transición entre las barrancas naturales del río y el golf del barrio. La casa se resuelve como una casa-patio diagramada en L, donde las áreas comunes conforman un espacio continuo que se vuelca hacia el patio y enmarca el bosque previo al golf. Las áreas privadas se ubican en uno de los extremos de la planta, aprovechando así la geometría para generar visuales con el exterior de manera más íntima.",
    },
    presentationImage: {
      src: "/casatimbo/render_3%20-%20Photo.png",
      wide: false,
      width: 1920,
      height: 1080,
      rowSpan: 2,
    ...
    imageCollage: [
      {
        src: "/casatimbo/render_1%20-%20Photo.png",
        wide: false,
        width: 1920,
        height: 1080,
      },
      {
        src: "/casatimbo/render_2%20-%20Photo.png",
        wide: false,
        width: 1920,
        height: 1080,
      },
      ...
      {
        src: "/casatimbo/render_4%20-%20Photo.png",
        wide: false,
        width: 1920,
        height: 1080,
      },
      {
        src: "/casatimbo/render_5%20-%20Photo.png",
        wide: false,
        width: 1920,
        height: 1080,
      },
      {
        src: "/casatimbo/01.implantacion.png",
        wide: false,
        width: 3508,
        height: 4963,
      },
      {
        src: "/casatimbo/02.planta.png",
        wide: false,
        width: 4963,
        height: 3508,
      },
      {
        src: "/casatimbo/03.vistas.png",
        wide: false,
        width: 4963,
        height: 3508,
      },
    ...
    type: { en: "Preliminary design", es: "Anteproyecto" },
    surface: "120m²",
  },
];
